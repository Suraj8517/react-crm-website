  ...
  return (
    <footer className="bg-gradient-to-b from-[#7025a5] to-[#49157d] text-gray-100 mt-16">
      <div className="max-w-7xl mx-auto px-6 md:px-8 py-12 text-center">
        ...
        {/* Resources */}
        <div className="mb-8">
          <h3 className="font-semibold text-white mb-3 text-lg">Resources</h3>
        ...
        {/* Social */}
        <div className="mb-8">
          <h3 className="font-semibold text-white mb-3 text-lg">Connect With Us</h3>
        ...
        {/* Divider */}
        <div className="border-t border-purple-500 mt-10 pt-6 text-sm text-gray-200">
