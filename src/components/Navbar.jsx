    ...
    <header className="sticky top-0 z-50 bg-white/70 backdrop-blur-xl border-b border-purple-100/50 shadow-sm">
      ...
      >
        ...
        <div className="flex items-center gap-2">
          ...
          <h4 className="text-transparent bg-clip-text bg-gradient-to-r from-purple-900 via-purple-700 to-indigo-600
      ...
      {menuOpen && (
        <div className="md:hidden bg-gradient-to-b from-white to-purple-50/30 backdrop-blur-xl border-t border-purple-100
